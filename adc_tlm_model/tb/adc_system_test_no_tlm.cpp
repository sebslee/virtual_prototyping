...
int sc_main (int argc , char *argv[]){
  ...
  sc_clock adc_clk("adc_clk" , 100 , SC_NS , 0.5 , 10 , SC_NS);
 ...
 wave_sine wave_cosine_i ("wave_cosine", 1000 , 1 , -M_PI/2 , 1 , false , false , 1); 
 ...
 analog_mux_i.analog_in_5(cosine);
 analog_mux_i.analog_in_7(saw);
...
parallelizer_i.data_valid(adc_drdy); 
 ...
 sca_trace( wf , sine , "adc_ch3");
 sca_trace( wf , cosine , "adc_ch5");
 sca_trace( wf , saw , "adc_ch7");
 ...
 sca_trace (wf , ch5_en , "ch5_en");
 sca_trace (wf , ch7_en , "ch7_en"); 
