...
void reg_file_target::update_regs(){
	...
	if(data_ch7[i].read())
      ...
      //TODO: Check this logic, only one channel can be enabled at a time!
	...
	data_tmp = 0x000000A8;
      ...
      //  cout << "@  " << sc_time_stamp() << " Reg file  ch3_en " << ch5_en.read() << endl;
      // cout << "@  " << sc_time_stamp() << " Low res   " << lowres.read() << endl;   
